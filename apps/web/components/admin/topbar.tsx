  ...
  return (
    <header className="sticky top-0 z-20 border-b border-slate-200 bg-white">
      <div className="flex h-16 items-center gap-3 px-4 lg:px-6">
        ...
        {/* Desktop search: inline. Hidden on mobile (rendered as a 2nd row below). */}
        <div className="hidden min-w-0 flex-1 items-center gap-2 sm:flex md:ml-6 md:max-w-sm">
          <MemberSearch
        ...
        {/* Spacer pushes bell + avatar to the right on mobile */}
      ...
      <div className="border-t border-slate-200 bg-slate-50 px-4 py-2 sm:hidden">
        <MemberSearch
          className="w-full"
          placeholder="Buscar socio…"
          onSelect={(m) => router.push(`/admin/miembros/${m.id}`)}
