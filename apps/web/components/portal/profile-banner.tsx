...
export function ProfileCompletionBanner() {
  ...
  return (
    <div className="bg-orange-500/10 border-b border-orange-500/30 px-6 py-3 flex items-center gap-3 text-sm">
      <AlertCircle className="w-4 h-4 text-orange-400 shrink-0" />
      <span className="flex-1 text-orange-100">
        Completa tu perfil para habilitar todas las funciones (toma 30 segundos).
      </span>
      <Link
